    ...
    <AppLayout>
      <div className="space-y-8">
        ...
        {isLoadingEmployees ? (
          ...
          <div className="bg-white rounded-2xl border-2 border-slate-200 shadow-lg overflow-hidden relative">
                ...
                {filteredEmployees.map((employee) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="absolute right-0 top-0 bottom-0 flex items-center">
                        <div className={cn(
                          "flex items-center space-x-1 px-3 py-2 rounded-l-lg shadow-lg",
